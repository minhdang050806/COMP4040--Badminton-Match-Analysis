...
from model.bst import BST_CG, BST_AP, BST_CG_AP
...
if __name__ == '__main__':
    ...
    task.get_network_architecture(model_name='BST_AP', in_channels=(3 if hyp.use_3d_pose else 2))
    task.seek_network_weights(model_info=model_info, serial_no=1)
