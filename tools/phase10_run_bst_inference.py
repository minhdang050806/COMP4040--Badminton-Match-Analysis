...
try:
    from phase04_run_bst_inference import build_model
    from bst_label_names import get_merged_stroke_types_english
except ModuleNotFoundError:
    from project.tools.phase04_run_bst_inference import build_model
    from project.tools.bst_label_names import get_merged_stroke_types_english
...
def main() -> None:
    ...
    summary = {
        ...
        "script": "project/tools/phase10_run_bst_inference.py",
