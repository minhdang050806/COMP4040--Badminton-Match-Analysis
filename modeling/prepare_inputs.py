...
try:
    from modeling.collate_features import get_bone_pairs, load_and_augment
    from modeling.label_names import get_merged_stroke_types_english, translate_stroke_type
...
def main() -> None:
    ...
    summary = {
        ...
        "script": "modeling/prepare_inputs.py",
        "status": "passed"
